      ...
      <SheetContent side="right" className="w-full sm:max-w-md">
                ...
                <li key={item.name} className="flex gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button className="text-xs text-muted-foreground hover:text-foreground" onClick={() => removeFromCart(item.name)}>Remove</button>
                    </div>
        ...
        <SheetFooter>
          ...
          <div className="flex gap-2">
            <Button variant="outline" className="flex-1" onClick={clearCart} disabled={cart.length === 0}>Clear</Button>
