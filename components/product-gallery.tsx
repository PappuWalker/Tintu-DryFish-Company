...
const ProductGallery = () => {
  ...
  if (loading) {
    return (
      <section className="container mx-auto px-4 py-10 text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-6">Product Spotlight</h2>
  ...
  return (
    <section className="container mx-auto px-4 py-10">
      <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">Product Spotlight</h2>
