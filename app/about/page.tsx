      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="relative -mt-20 md:-mt-24 bg-background/85 backdrop-blur rounded-2xl p-6 md:p-8 shadow-xl">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-foreground">About Tintu Cuts</h1>
      ...
      <section className="container mx-auto px-4 pb-14">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-border bg-card p-6">
            ...
            <p className="text-sm text-muted-foreground">Fresh sourcing, cold chain maintenance, and expert cuts.</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-6">
            <h3 className="font-semibold text-lg mb-2 text-foreground">Trust</h3>
            <p className="text-sm text-muted-foreground">Transparent processes and reliable delivery windows.</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-6">
            <h3 className="font-semibold text-lg mb-2 text-foreground">Care</h3>
            <p className="text-sm text-muted-foreground">Eco-conscious packaging and customer-first support.</p>
          </div>
        </div>
      </section>
